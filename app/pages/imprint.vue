...
<template>
    <div class="max-w-6xl mx-auto px-4 py-12">
        <section id="imprint" class="pb-4">
            ...
            <h2 class="text-xl">Verbraucher&shy;streit&shy;beilegung/Universal&shy;schlichtungs&shy;stelle</h2>
        ...
        <section id="privacy" class="pt-24 -mt-18">
            ...
            <p class="pb-2">Die folgenden Hinweise geben einen einfachen Überblick darüber, was mit Ihren
            ...
            <h4 class="text-lg pb-2">Datenerfassung auf dieser Website</h4>
            <p class="italic">Wer ist verantwortlich für die Datenerfassung auf dieser Website?</p>
            <p class="pb-2">Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber. Dessen
                Kontaktdaten können
            ...
            <p class="pb-2">Ihre Daten werden zum einen dadurch erhoben, dass Sie uns diese mitteilen. Hierbei kann es
                sich z. B. um
                Daten
            ...
            <p class="pb-2">
                ...
                Daten
                können zur Analyse Ihres Nutzerverhaltens verwendet werden. Sofern über die Website Verträge geschlossen
                oder
                angebahnt werden können, werden die übermittelten Daten auch für Vertragsangebote, Bestellungen oder
                sonstige
                Auftragsanfragen verarbeitet.
            </p>
            <p class="italic">Welche Rechte haben Sie bezüglich Ihrer Daten?</p>
            <p class="pb-2">Sie haben jederzeit das Recht, unentgeltlich Auskunft über Herkunft, Empfänger und Zweck
                Ihrer
                gespeicherten
                personenbezogenen Daten zu erhalten. Sie haben außerdem ein Recht, die Berichtigung oder Löschung dieser
                Daten
                zu verlangen. Wenn Sie eine Einwilligung zur Datenverarbeitung erteilt haben, können Sie diese
                Einwilligung
                ...
                Datenschutz können Sie sich jederzeit an uns wenden.</p>
            <p class="italic">Analyse-Tools und Tools von Dritt­anbietern</p>
            <p class="pb-2">Beim Besuch dieser Website kann Ihr Surf-Verhalten statistisch ausgewertet werden. Das
                geschieht vor
            ...
            <h3 class="text-xl font-bold pb-2">2. Hosting</h3>
            <p class="pb-2">
            ...
            <p class="pb-2">Wir setzen folgende(n) Hoster ein:</p>
            <p class="pb-2">
            ...
            <h3 class="text-xl font-bold pb-2">3. Allgemeine Hinweise und Pflicht­informationen</h3>
            <h4 class="text-lg">Datenschutz</h4>
            <p class="pb-2">
            ...
            <h4 class="text-lg">Hinweis zur verantwortlichen Stelle</h4>
            <p class="pb-2">Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:</p>
            <p class="pb-2">
                Leon Krieger <br />
                Kastanienweg 51 <br />
                53757 Sankt Augustin <br />
                Deutschland <br />
                Telefon: +49 (0) 2241 26159 13 <br />
                E-Mail: info@krieger.biz
            </p>
            <p class="pb-2">
            ...
            <h4 class="text-lg">Speicherdauer</h4>
            <p class="pb-2">
            ...
            <h4 class="text-lg">Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser Website
            </h4>
            <p class="pb-2">
                ...
                Grundlage
                von
                § 25 Abs. 1 TDDDG. Die Einwilligung ist jederzeit widerrufbar. Sind Ihre Daten zur Vertragserfüllung
                oder
                zur
                Durchführung vorvertraglicher Maßnahmen erforderlich, verarbeiten wir Ihre Daten auf Grundlage des Art.
                6
                Abs. 1
                ...
                ferner
                auf Grundlage unseres berechtigten Interesses nach Art. 6 Abs. 1 lit. f DSGVO erfolgen. Über die jeweils
                im
                Einzelfall einschlägigen Rechtsgrundlagen wird in den folgenden Absätzen dieser Datenschutzerklärung
                informiert.
            </p>

            <h4 class="text-lg">Empfänger von personenbezogenen Daten</h4>
            <p class="pb-2">
                ...
                Steuerbehörden),
                wenn wir ein berechtigtes Interesse nach Art. 6 Abs. 1 lit. f DSGVO an der Weitergabe haben oder wenn
                eine
                ...
                weiter. Im Falle einer gemeinsamen Verarbeitung wird ein Vertrag über gemeinsame Verarbeitung
                geschlossen.
            </p>
            <h4 class="text-lg"> Widerruf Ihrer Einwilligung zur Datenverarbeitung</h4>
            <p class="pb-2">
            ...
            <h4 class="text-lg">Widerspruchsrecht gegen die Datenerhebung in besonderen Fällen sowie gegen Direktwerbung
                (Art. 21 DSGVO)</h4>
            <p class="pb-2">
                ...
                AUSÜBUNG
                ODER
                VERTEIDIGUNG VON RECHTSANSPRÜCHEN (WIDERSPRUCH NACH ART. 21 ABS. 1 DSGVO). <br />
            ...
            <h4 class="text-lg"> Beschwerde­recht bei der zuständigen Aufsichts­behörde</h4>
            <p class="pb-2">
            ...
            <h4 class="text-lg">Recht auf Daten­übertrag­barkeit</h4>
            <p class="pb-2">
            ...
            <h4 class="text-lg">Auskunft, Berichtigung und Löschung</h4>
            <p class="pb-2">
            ...
            <h4 class="text-lg">Recht auf Einschränkung der Verarbeitung</h4>
            <p class="pb-2">
            ...
            <h4 class="text-lg"> SSL- bzw. TLS-Verschlüsselung</h4>
            <p class="pb-2">
            ...
            <h3 class="text-xl font-bold pb-2">4. Datenerfassung auf dieser Website</h3>
            <h4 class="text-lg">Cookies</h4>
            <p class="pb-2">
                ...
                löschen
                oder eine automatische Löschung durch Ihren Webbrowser erfolgt. <br />
                ...
                innerhalb
                von
                Webseiten (z. B. Cookies zur Abwicklung von Zahlungsdienstleistungen). <br />
                Cookies haben verschiedene Funktionen. Zahlreiche Cookies sind technisch notwendig, da bestimmte
                Webseitenfunktionen ohne diese nicht funktionieren würden (z. B. die Warenkorbfunktion oder die Anzeige
                von
                Videos). Andere Cookies können zur Auswertung des Nutzerverhaltens oder zu Werbezwecken verwendet
                werden. <br />
                ...
                dieser
                Einwilligung (Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TDDDG); die Einwilligung ist jederzeit
                widerrufbar. <br />
            ...
            <h4 class="text-lg">Kontaktformular</h4>
            <p class="pb-2">
            ...
            <h4 class="text-lg">Anfrage per E-Mail, Telefon oder Telefax</h4>
            <p class="pb-2">
            ...
            <h3 class="text-xl font-bold pb-2">5. Plugins und Tools</h3>
            <h4 class="text-lg">Cloudflare CMS</h4>
            <p class="pb-2">
                Wir nutzen das Content Delivery Network (CDN) von Cloudflare Germany GmbH, Rosental 7, c/o Mindspace,
                80331
                München Deutschland (Cloudflare), um die Sicherheit und die Auslieferungsgeschwindigkeit unserer Website
                zu
                erhöhen. Dies entspricht unserem berechtigten Interesse (Art. 6 Abs. 1 lit. f DSGVO). Ein CDN ist ein
                Netzwerk
                aus [weltweit] verteilten Servern, das in der Lage ist, optimiert Inhalte an den Websitenutzer
                auszuliefern.
                Für
                diesen Zweck können personenbezogene Daten in Server-Logfiles von Cloudflare verarbeitet werden. Bitte
                ...
                entspricht
                unserem berechtigten Interesse im Sinne des Art. 6 Abs. 1 S. 1 lit. f DSGVO, selbst kein Content
                Delivery
                ...
                finden
                Sie unter:https://www.cloudflare.com/cloudflare-customer-scc/.
            </p>
            <h4 class="text-lg">Cloudflare Turnstile</h4>
            <p class="pb-2">
                Wir nutzen Cloudflare Turnstile (im Folgenden „Turnstile“) auf dieser Website. Anbieter ist die
                Cloudflare
                Inc.,
                101 Townsend St., San Francisco, CA 94107, USA (im Folgenden „Cloudflare”).
                Mit Turnstile soll überprüft werden, ob die Dateneingabe auf dieser Website (z. B. in einem
                Kontaktformular)
                durch einen Menschen oder durch ein automatisiertes Programm erfolgt. Hierzu analysiert Turnstile das
                Verhalten
                ...
                betritt.
                Zur Analyse wertet Turnstile verschiedene Informationen aus (z. B. IP-Adresse, Verweildauer des
                Websitebesuchers
                auf der Website oder vom Nutzer getätigte Mausbewegungen). Die bei der Analyse erfassten Daten werden an
                ...
                bei Datenverarbeitungen in den USA gewährleisten soll. Jedes nach dem DPF zertifizierte Unternehmen
                verpflichtet
                sich, diese Datenschutzstandards einzuhalten. Weitere Informationen hierzu erhalten Sie vom Anbieter
                unter
                folgendem Link: https://www.dataprivacyframework.gov/participant/5666.
            </p>
            <h4 class="text-lg">Google Analytics</h4>
            <p class="pb-2">
                Wir verwenden Google Analytics, um die Website-Nutzung zu analysieren. Die daraus gewonnenen Daten
                werden
                genutzt, um unsere Website sowie Werbemaßnahmen zu optimieren.
                Google Analytics wird uns von Google Ireland Limited (Gordon House, Barrow Street, Dublin 4, Irland)
                bereitgestellt. Google verarbeitet die Daten zur Website-Nutzung in unserem Auftrag und verpflichtet
                sich
                vertraglich zu Maßnahmen, um die Sicherheit und Vertraulichkeit der verarbeiteten Daten zu
                gewährleisten.
                Während Ihres Website-Besuchs werden u.a. folgende Daten an Google übermittelt:<br />
                Aufgerufene Seiten<br />
                Die Erreichung von "Website-Zielen" (z.B. Kontaktanfragen)<br />
                Ihr Verhalten auf den Seiten (beispielsweise Verweildauer, Klicks, Scrolltiefe)<br />
                Ihr ungefährer Standort (Land und Stadt)<br />
                Ihre Internetadresse (IP-Adresse)<br />
                Technische Informationen wie Browser, Internetanbieter, Endgerät und Bildschirmauflösung<br />
                Herkunftsquelle Ihres Besuchs (d.h. über welche Website bzw. über welches Werbemittel Sie zu uns
                gekommen
                sind)<br />
                Eine zufallsgenerierte User-ID<br />
                Es werden keine persönliche Daten wie Name, Anschrift oder Kontaktdaten an Google Analytics übertragen.
                Diese Daten werden an Server von Google in den USA übertragen. Wir weisen darauf hin, dass in den USA
                datenschutzrechtlich nicht das gleiche Schutzniveau wie innerhalb der EU garantiert werden kann.
                Google Analytics speichert Cookies in Ihrem Webbrowser für die Dauer von zwei Jahren seit Ihrem letzten
                Besuch.
                Diese Cookies enthaltene eine zufallsgenerierte User-ID, mit der Sie bei zukünftigen Website-Besuchen
                ...
                Sollten Sie mit der Erfassung nicht einverstanden sein, können Sie diese mit der einmaligen Installation
                des
                Browser-Add-ons zur Deaktivierung von Google Analytics unterbinden oder durch das Ablehnen der Cookies
                über
